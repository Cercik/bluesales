...
WHATSAPP_APISPERU_ENABLED=false
WHATSAPP_APISPERU_BASE_URL=https://whatsapp.apisperu.com/api/v1
WHATSAPP_APISPERU_TOKEN=
WHATSAPP_APISPERU_DEVICE_ID=
WHATSAPP_APISPERU_TIMEOUT_MS=8000
WHATSAPP_APISPERU_AUTO_SEND_ORDER_NOTIFICATIONS=true
```
